          ...
          main={
            <div className="info-box">
              ...
              <ul className="store-info">
                <li>
                  <i class="fas fa-map-marker-alt" /> 101 Tran Hung Dao, Pham Ngu Lao, District 1, Ho Chi Minh
                </li>
                <li>
              ...
              <ul className="opening-info">
                <li><i class="fas fa-calendar-check"></i> Monday - Sunday</li>
                <li><i class="fas fa-clock"></i> 9 a.m - 10 p.m</li>
              </ul>
            </div>
          }
          cart={null}
